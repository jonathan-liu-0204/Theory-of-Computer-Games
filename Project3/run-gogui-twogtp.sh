...
P1B='./nogo --shell --name="Hollow-Black" --black="mcts N=200 c=0.1 timer=1 option=uct_value"'
P1W='./nogo --shell --name="Hollow-White" --white="mcts N=200 c=0.1 timer=1 option=uct_value"'
