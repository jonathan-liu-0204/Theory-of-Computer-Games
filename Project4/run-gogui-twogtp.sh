...
P1B='./nogo --shell --name="Jonathan_Liu_2" --black="mcts N=300 c=1.414"'
P1W='./nogo --shell --name="Jonathan_Liu_2" --white="mcts N=300 c=1.414"'
...
P2B="gogui-client tcglinux6 16666"
P2W="gogui-client tcglinux6 16666"
